...
**Status:** done
**Covered by:** test/coding-confidentiality.int-spec.ts

- [x] No hidden input or expected output is returned by any student-reachable route
- [x] A failing hidden case reports its ordinal and the failure kind, and nothing else
- [x] Runtime and compilation error output is scrubbed of hidden input before it reaches a student
- [x] The response shape is identical whether a hidden case exists, passes or fails
- [x] An instructor still sees hidden cases in full
