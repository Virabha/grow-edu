...
- **The demo-mode mock layer is deleted.** It was 4,870 lines across both frontends, monkey-patched global fetch and permitted any password to sign in. The collapse left it faking an API surface that no longer exists, which settled the open question in `AUDIT.md` §8.
