...
import { LayoutDashboard, Users, BookOpen, Building2, CreditCard, BarChart3, Shield, Settings, Tag, Layers, Layout, FileText, Library, ClipboardList } from "lucide-react";
const sidebarItems = [
    ...
    { label: "Service Applications", href: "/admin/service-applications", icon: <ClipboardList className="h-4 w-4"/> },
