    ...
    return (<footer className="bg-muted/50 border-t border-border py-6 sm:py-8 px-4 sm:px-5" role="contentinfo" aria-label="Site footer">
      <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        <div className="space-y-2 col-span-2 sm:col-span-2 md:col-span-1">
          <Link href="/" aria-label="Loshi Edu - Home">
            <h2 className="text-sm sm:text-base font-bold text-foreground">
              Loshi <span className="text-primary">Edu</span>
            </h2>
          </Link>
          ...
          <address className="text-muted-foreground/70 text-xs not-italic">
            <p>
              <a href="mailto:info@loshiedu.com" className="hover:text-primary transition-colors">
                info@loshiedu.com
              </a>
            </p>
          </address>
        ...
        <nav aria-label="Academy navigation">
          ...
          <ul className="space-y-1.5 text-xs text-muted-foreground">
            <li>
              <Link href="#why-loshi-edu" className="hover:text-primary transition-colors">
                About Us
              </Link>
            </li>
            <li>
      ...
      <div className="mt-6 pt-4 border-t border-border max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-muted-foreground/60 text-xs text-center md:text-left">
            © {currentYear} Loshi Edu. All rights reserved.
          </p>
          <nav aria-label="Social media links">
            <ul className="flex items-center gap-4">
              <li>
                <a href="https://www.facebook.com/loshiedu" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors" aria-label="Follow us on Facebook">
              ...
              <li>
                <a href="https://www.linkedin.com/company/loshiedu" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors" aria-label="Connect with us on LinkedIn">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <a href="https://www.instagram.com/loshiedu" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors" aria-label="Follow us on Instagram">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
